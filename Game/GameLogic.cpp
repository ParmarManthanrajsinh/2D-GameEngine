...
void GameLogic::Update(float deltaTime) {
    if (!m_gameStarted || !m_coreEngine) return;
    ...
    if (m_player.position.x < m_player.radius) m_player.position.x = m_player.radius;
    if (m_player.position.x > m_sceneWidth - m_player.radius) m_player.position.x = m_sceneWidth - m_player.radius;
    if (m_player.position.y < m_player.radius) m_player.position.y = m_player.radius;
    if (m_player.position.y > m_sceneHeight - m_player.radius) m_player.position.y = m_sceneHeight - m_player.radius;
