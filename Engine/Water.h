...
bool Water::b_LoadTexture(const char* filename)
{
...
void Water::SetUseTexture(bool use)
{
	b_UseTexture = use && (particle_texture.id > 0);
}

bool Water::b_IsUsingTexture() const
{
	return b_UseTexture && (particle_texture.id > 0);
}

Vector2 Water::GetEmissionPoint()
{
...
void Water::DrawEmitterShape() const
{
